  ...
  return (
    <div className="bg-transparent h-full w-full flex flex-col justify-center items-center rounded-lg shadow-2xl relative z-[60]">
      ...
      <motion.div
        ...
        className="relative px-8 pb-4 z-[70] flex justify-center items-center text-center"
      >
        <p className="text-xl md:text-3xl lg:text-4xl text-white">{selected?.content}</p>
        </motion.div>
    </div>
  );
};
