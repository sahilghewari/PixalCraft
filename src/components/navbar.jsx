      ...
      <div className={`max-w-7xl mx-auto flex items-center px-4 ${isDashboard ? 'justify-between' : 'justify-between'}`}>
        ...
        {!isDashboard && (
          <div className="space-x-8 hidden md:flex">
            <a href="/features" className="font-jersey text-3xl font-semibold text-stone-900 hover:text-blue-900 transition-colors duration-200 hover:scale-105">
              Features
            </a>
            <a href="/dashboard" className="font-jersey text-3xl font-semibold text-stone-900 hover:text-blue-900 transition-colors duration-200 hover:scale-105">
              Dashboard
            </a>
            <a href="/pricing" className="font-jersey text-3xl font-semibold text-stone-900 hover:text-blue-900 transition-colors duration-200 hover:scale-105">
              Pricing
            </a>
            <a href="/contact" className="font-jersey text-3xl font-semibold text-stone-900 hover:text-blue-900 transition-colors duration-200 hover:scale-105">
              Contact
            </a>
          </div>
        )}
